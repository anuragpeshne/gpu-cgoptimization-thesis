...
\SetTitle{ENHANCING THE PARALLEL PROGRAMMING ENVIRONMENT, SIA/ACES4, WITH GPU SUPPORT AND DATA PREFETCHING}
...
\include{tex/chapter5} % exploiting gpu
\include{tex/chapter6} % experiment and result
\include{tex/chapter7} % conclusion and future work
