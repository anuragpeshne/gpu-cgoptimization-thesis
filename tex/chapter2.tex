...
than memory blocks. Further exact sequence in which blocks are needed is also known.
...
once block is prefetched and computed on, the block can be safely evicted from
