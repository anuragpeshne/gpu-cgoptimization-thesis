...
\begin{figure}[h] %place figure "here"
  \begin{tikzpicture}[
    ...
    title/.style={draw=none, color=gray, inner sep=0pt},
    thickarrow/.style={draw=black, solid, line width=1mm,
      preaction={-triangle 90, thin, draw, shorten >=-1mm}},
    thickblue/.style={<-, draw=blue, thick, line width=1mm, shorten <= 2pt, shorten >= 2pt, bend right=45},
    thickorange/.style={<-, draw=orange, thick, line width=1mm, shorten <= 2pt, shorten >= 2pt, bend right=10}]
  ...
  \end{tikzpicture}
  \caption{GPU Memory Buffer Transfer Over MPI}\label{fig:gpu_buff_transfer}
\end{figure}