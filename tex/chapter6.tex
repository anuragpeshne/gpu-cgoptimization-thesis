...
Results of executing CCSD calculation on $C_{20}$ molecule in a CC-PVDZ basis is
...
\begin{figure}[h]
  ...
  \tikz{\path[draw,fill={rgb:red,30;green,185;blue,3}] (0,0) rectangle (1cm,0.5cm);} w/~~Prefetch Total \texttt{wait\_time}.
  \tikz{\path[draw,fill={rgb:red,195;green,3;blue,3}] (0,0) rectangle (1cm,0.5cm);}  w/~~Prefetch Barrier \texttt{wait\_time}
  \caption{Overall \texttt{wait\_time} improvement in CCSD calculation for $C_{20}$ molecule in a CC-PVDZ basis with 512 CPUs}
...
\begin{figure}[h]
  ...
  \tikz{\path[draw,fill={rgb:red,30;green,185;blue,3}] (0,0) rectangle (1cm,0.5cm);} w/~~Prefetch Total \texttt{wait\_time}.
  \tikz{\path[draw,fill={rgb:red,195;green,3;blue,3}] (0,0) rectangle (1cm,0.5cm);}  w/~~Prefetch Barrier \texttt{wait\_time}
  \caption{Overall \texttt{wait\_time} improvement in CCSD calculation for $C_{20}$ molecule in a CC-PVDZ basis with 32 CPUs}
