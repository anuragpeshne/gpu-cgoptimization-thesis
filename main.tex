...
\SetTitle{USING GPU TO EXPLOIT COURSE GRAINED CONCURRENCY IN SUPER INSTRUCTION ARCHITECTURE}
...
\include{tex/chapter2} % related work
\include{tex/chapter3} % background
\include{tex/chapter4} % block prefetching
\include{tex/chapter5} % gpu techniques
\include{tex/chapter6} % design and implementation of memory management and prefetch
\include{tex/chapter7} % experiment and result
\include{tex/chapter8} % conclusion and future work
